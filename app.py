...
def cancerPrediction(img):
    ...
    prediction = "Cancer" if prediction_raw == 0 else "Non-Cancer"
...
patient_age = st.sidebar.number_input("Age", min_value=1, max_value=120, step=1)
patient_gender = st.sidebar.selectbox("Gender", ["Male", "Female", "Other"])
save_details = st.sidebar.button("Save Details")
